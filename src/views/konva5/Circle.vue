...
onMounted(() => {
  const { draggable, deviceType, stroke, strokeWidth, fill } = props.targetNode.attrs;
  console.log('onMounted===>', draggable, deviceType, stroke, strokeWidth, fill);
  formData.value = { ...formData.value, draggable, deviceType, stroke, strokeWidth, fill };
});
