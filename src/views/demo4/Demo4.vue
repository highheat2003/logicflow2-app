...
import { Control, Menu, MiniMap, DndPanel, SelectionSelect } from '@logicflow/extension';
...
onMounted(() => {
  const lf = new LogicFlow({
    ...
    grid: true,
    plugins: [Control, Menu, MiniMap, DndPanel, SelectionSelect],
    pluginsOptions: {
      miniMap: {
        ...miniMapOptions,
        showEdge: true,
...
function onUpdateProps(data) {
  ...
  */
  lf.setProperties(data.id, { ...data.properties });
  lf.updateText(data.id, data.text.value);
}
...
<template>
  <el-card header="demo4 : 속성Drawer를 component로 분리, defineModel적용">
